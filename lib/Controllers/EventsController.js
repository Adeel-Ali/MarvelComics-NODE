...
var EventsController = {
     ...
     * @return {Event}
     */
    getEventIndividual : function(eventId, callback){

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/events/{eventId}";
        ...
        function cb(_error, _response, _context) {
            if(_error) {
                ...
                callback({errorMessage: "Event not found.", errorCode: 404, errorResponse:_response.body},null,_context);
            } else {
     ...
     */
    getEventCharacterCollection : function(eventId, comics, limit, modifiedSince, name, nameStartsWith, offset, orderBy, series, stories, callback){

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/events/{eventId}/characters";
    ...
    getComicsCollectionByEventId : function(eventId, characters, collaborators, creators, dateDescriptor, dateRange, diamondCode, digitalId, ean, events, format, formatType, hasDigitalIssue, isbn, issn, issueNumber, limit, modifiedSince, noVariants, offset, orderBy, series, sharedAppearances, startYear, stories, title, titleStartsWith, upc, callback){
        ...
        var _queryBuilder = _baseUri + "/events/{eventId}/comics";
     ...
     */
    getCreatorCollectionByEventId : function(eventId, comics, firstName, firstNameStartsWith, lastName, lastNameStartsWith, limit, middleName, middleNameStartsWith, modifiedSince, nameStartsWith, offset, orderBy, series, stories, suffix, callback){

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/events/{eventId}/creators";
     ...
     */
    getEventSeriesCollection : function(eventId, characters, comics, contains, creators, limit, modifiedSince, offset, orderBy, seriesType, startYear, stories, title, titleStartsWith, callback){

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/events/{eventId}/series";
     ...
     */
    getEventStoryCollection : function(eventId, characters, comics, creators, limit, modifiedSince, offset, orderBy, series, callback){

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/events/{eventId}/stories";
     ...
     */
    getEventsCollection : function(characters, comics, creators, limit, modifiedSince, name, nameStartsWith, offset, orderBy, series, stories, callback){

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/events";
