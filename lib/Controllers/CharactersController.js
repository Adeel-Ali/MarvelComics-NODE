...
var CharactersController = {
     ...
     * @return {Character}
     */
    getCharacterIndividual : function(characterId, callback){

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/characters/{characterId}";
        ...
        function cb(_error, _response, _context) {
            if(_error) {
                ...
                callback({errorMessage: "Character not found.", errorCode: 404, errorResponse:_response.body},null,_context);
            } else {
    ...
    getComicsCharacterCollection : function(characterId, collaborators, creators, dateDescriptor, dateRange, diamondCode, digitalId, ean, events, format, formatType, hasDigitalIssue, isbn, issn, issueNumber, limit, modifiedSince, noVariants, offset, orderBy, series, sharedAppearances, startYear, stories, title, titleStartsWith, upc, callback){
        ...
        var _queryBuilder = _baseUri + "/characters/{characterId}/comics";
     ...
     */
    getCharacterEventsCollection : function(characterId, comics, creators, limit, modifiedSince, name, nameStartsWith, offset, orderBy, series, stories, callback){

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/characters/{characterId}/events";
     ...
     */
    getCharacterSeriesCollection : function(characterId, comics, contains, creators, events, limit, modifiedSince, offset, orderBy, seriesType, startYear, stories, title, titleStartsWith, callback){

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/characters/{characterId}/series";
     ...
     */
    getCharacterStoryCollection : function(characterId, comics, creators, events, limit, modifiedSince, offset, orderBy, series, callback){

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/characters/{characterId}/stories";
     ...
     */
    getCharacterCollection : function(comics, events, limit, modifiedSince, name, nameStartsWith, offset, orderBy, series, stories, callback){

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/characters";
